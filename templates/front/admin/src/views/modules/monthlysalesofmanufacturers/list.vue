	...
	<div class="main-content" :style='{"padding":"60px 30px","margin":"0 0 0 65px","fontSize":"15px"}'>
		...
		<template v-if="showFlag">
			<el-form class="center-form-pv" :style='{"margin":"0 10px 0px"}' :inline="true" :model="searchForm">
				...
				<el-row class="actions" :style='{"padding":"10px","margin":"0px 0","flexWrap":"wrap","background":"none","display":"flex"}'>
					<el-button class="add" v-if="isAuth('monthlysalesofmanufacturers','新增')" type="success" @click="addOrUpdateHandler()">
						<span class="icon iconfont icon-tianjia1" :style='{"margin":"0 2px","fontSize":"14px","color":"#fff","borderRadius":"5px","height":"34px"}'></span>
						添加
					</el-button>
					<el-button class="del" v-if="isAuth('monthlysalesofmanufacturers','删除')" :disabled="dataListSelections.length?false:true" type="danger" @click="deleteHandler()">
						<span class="icon iconfont icon-shanchu6" :style='{"margin":"0 2px","fontSize":"14px","color":"#6EADEF","height":"34px"}'></span>
						删除
					</el-button>

					<el-button class="btn18" v-if="isAuth('monthlysalesofmanufacturers','导入')" type="success" @click="importHandler()">
						<span class="icon iconfont icon-xihuan" :style='{"margin":"0 2px","fontSize":"14px","color":"#fff","display":"none","height":"34px"}'></span>
						导入
					</el-button>
					<el-button class="btn18" v-if="isAuth('monthlysalesofmanufacturers','上传模板')" type="success" @click="importClcik">
						<span class="icon iconfont icon-xihuan" :style='{"margin":"0 2px","fontSize":"14px","color":"#fff","display":"none","height":"34px"}'></span>
						上传模板
					</el-button>
					<el-button class="btn18" v-if="isAuth('monthlysalesofmanufacturers','下载模板')" type="success" @click="download('upload/monthlysalesofmanufacturers_template.xlsx')">
						<span class="icon iconfont icon-xihuan" :style='{"margin":"0 2px","fontSize":"14px","color":"#fff","display":"none","height":"34px"}'></span>
						下载模板
					</el-button>

					<el-button class="btn18" v-if="isAuth('monthlysalesofmanufacturers','生成数据')" type="success" @click="genDataClick()">
						<span class="icon iconfont icon-xihuan" :style='{"margin":"0 2px","fontSize":"14px","color":"#fff","display":"none","height":"34px"}'></span>
						生成数据
					</el-button>
					<el-button class="btn18" v-if="isAuth('monthlysalesofmanufacturers','厂商销量统计')" type="success" @click="chartDialog1()">
						<span class="icon iconfont icon-xihuan" :style='{"margin":"0 2px","fontSize":"14px","color":"#fff","display":"none","height":"34px"}'></span>
						厂商销量统计
					</el-button>
					<el-button class="btn18" v-if="isAuth('monthlysalesofmanufacturers','每年销售量统计(年)')" type="success" @click="chartDialog2()">
						<span class="icon iconfont icon-xihuan" :style='{"margin":"0 2px","fontSize":"14px","color":"#fff","display":"none","height":"34px"}'></span>
						每年销售量统计(年)
					</el-button>
					<el-button class="btn18" v-if="isAuth('monthlysalesofmanufacturers','每月销售量统计(月)')" type="success" @click="chartDialog3()">
						<span class="icon iconfont icon-xihuan" :style='{"margin":"0 2px","fontSize":"14px","color":"#fff","display":"none","height":"34px"}'></span>
						每月销售量统计(月)
					</el-button>
				</el-row>
			...
			<div :style='{"width":"100%","padding":"0 10px","fontSize":"14px","color":"#000"}'>
				<el-table class="tables"
					...
					:border='true'
					v-if="isAuth('monthlysalesofmanufacturers','查看')"
					:data="dataList"
				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column :resizable='true' :sortable='true'  
						prop="shareofsalesvolume"
						label="占销量份额">
						<template slot-scope="scope">
							{{scope.row.shareofsalesvolume}}
						</template>
					</el-table-column>
					<el-table-column width="300" label="操作">
						<template slot-scope="scope">
							<el-button class="view" v-if=" isAuth('monthlysalesofmanufacturers','查看')" type="success" @click="addOrUpdateHandler(scope.row.id,'info')">
								<span class="icon iconfont icon-xihuan" :style='{"margin":"0 2px","fontSize":"14px","color":"#fff","display":"none","height":"40px"}'></span>
								查看
							</el-button>
							<el-button class="edit" v-if=" isAuth('monthlysalesofmanufacturers','修改') " type="success" @click="addOrUpdateHandler(scope.row.id)">
								<span class="icon iconfont icon-xihuan" :style='{"margin":"0 2px","fontSize":"14px","color":"#fff","display":"none","height":"40px"}'></span>
								修改
							</el-button>
							...
							<el-button class="del" v-if="isAuth('monthlysalesofmanufacturers','删除') " type="primary" @click="deleteHandler(scope.row.id )">
								<span class="icon iconfont icon-xihuan" :style='{"margin":"0 2px","fontSize":"14px","color":"#fff","display":"none","height":"40px"}'></span>
								删除
							</el-button>
						</template>
		...
		<el-dialog title="导入" :visible.sync="importVisiable" width="50%">
			<el-form ref="form" :model="form" label-width="80px">
				<el-form-item class="upload" label="文件" prop="excelFile">
				  <excel-file-upload
				  tip="点击上传直接导入excel文件"
				  action="monthlysalesofmanufacturers/importExcel"
				  :limit="1"
				  :fileUrls="importUrl"
				  @change="importChange"
				  ></excel-file-upload>
		...
		<el-dialog title="上传模板" :visible.sync="importVis" width="50%">
			<el-form ref="form" :model="importForm" label-width="80px">
				<el-form-item class="upload" label="文件" prop="excelFile">
					<el-upload class="upload-demo" drag :action="$base.url + 'file/upload?type=monthlysalesofmanufacturers_template'"
		...
		<el-dialog
			...
			width="800">
			<div id="manufacturerChart1" style="width:100%;height:600px;"></div>
			<span slot="footer" class="dialog-footer">
		...
		<el-dialog
			...
			width="800">
			<div id="manufacturerChart2" style="width:100%;height:600px;"></div>
			<span slot="footer" class="dialog-footer">
		...
		<el-dialog
			...
			width="800">
			<div id="manufacturerChart3" style="width:100%;height:600px;"></div>
			<span slot="footer" class="dialog-footer">
	...
	export default {
		...
		methods: {
			...
			chartDialog1() {
				...
				this.$nextTick(()=>{
					var manufacturerChart1 = echarts.init(document.getElementById("manufacturerChart1"),'macarons');
					this.$http({
						url: `monthlysalesofmanufacturers/value/shareofsales/manufacturer`,
						method: "get",
					}).then(({ data }) => {
						if (data && data.code === 0) {
							let res = data.data;
							...
							// 使用刚指定的配置项和数据显示图表。
							manufacturerChart1.setOption(option);
							  //根据窗口的大小变动图表
							window.onresize = function() {
								manufacturerChart1.resize();
							};
						}else{
							this.$message({
								message: data.msg,
			...
			chartDialog2() {
				...
				this.$nextTick(()=>{
					...
					var manufacturerChart2 = echarts.init(document.getElementById("manufacturerChart2"),'macarons');
					this.$http({
						url: `monthlysalesofmanufacturers/value/year/manufacturer`,
						method: "get",
					}).then(({ data }) => {
						if (data && data.code === 0) {
							let res = data.data;
							...
							// 使用刚指定的配置项和数据显示图表。
							manufacturerChart2.setOption(option);
							//根据窗口的大小变动图表
							window.onresize = function() {
								manufacturerChart2.resize();
							};
						}else{
							this.$message({
								message: data.msg,
			...
			chartDialog3() {
				...
				this.$nextTick(()=>{
					...
					var manufacturerChart3 = echarts.init(document.getElementById("manufacturerChart3"),'macarons');
					this.$http({
						url: `monthlysalesofmanufacturers/value/month/manufacturer`,
						method: "get",
					}).then(({ data }) => {
						if (data && data.code === 0) {
							let res = data.data;
						...
						option = {
							...
							// 使用刚指定的配置项和数据显示图表。
							manufacturerChart3.setOption(option);
							//根据窗口的大小变动图表
							window.onresize = function() {
								manufacturerChart3.resize();
							};
						}else{
							this.$message({
								message: data.msg,
			...
			getDataList() {
				...
				this.$http({
					url: "monthlysalesofmanufacturers/page",
					method: "get",
					params: params
				}).then(({ data }) => {
					if (data && data.code === 0) {
			...
			async deleteHandler(id ) {
				...
				await this.$confirm(`确定进行[${id ? "删除" : "批量删除"}]操作?`, "提示", {
					...
					await this.$http({
						url: "monthlysalesofmanufacturers/delete",
						method: "post",
						data: ids
					}).then(async ({ data }) => {
						if (data && data.code === 0) {
			...
			genDataSave(){
				...
				this.$http({
					url: 'monthlysalesofmanufacturers/batch/gen?recordNum=' + this.genDataForm.recordNum,
					method: 'post'
				}).then(res=>{
